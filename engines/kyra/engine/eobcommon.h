...
public:
	...
	uint32 extendedExpRequirementTables[6][21] = {
		{ 0, 2000, 4000, 8000, 16000, 32000, 64000, 125000, 250000, 500000, 750000, 1000000, 1250000, 1500000, 1750000, 2000000, 2250000, 2500000, 2750000, 3000000, 0xFFFFFFFF }, /* Fighter */
